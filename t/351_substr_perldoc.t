...
my $color  = Char::Latin1::substr $s, 4, 5;   # black
my $middle = Char::Latin1::substr $s, 4, -11; # black cat climbed the
my $end    = Char::Latin1::substr $s, 14;     # climebed the green tree
my $tail   = Char::Latin1::substr $s, -4;     # tree
my $z      = Char::Latin1::substr $s, -4, 2;  # tr
