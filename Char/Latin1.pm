...
######################################################################
#
# Char::Latin1 - Source code filter to Latin-1 script
#
...
sub Char::Latin1::escape_script {
    ...
    if (/^ use Char::Elatin1(?:\s+[0-9\.]*)?\s*; $/oxms) {
        ...
        $e_script .= sprintf("use Char::Elatin1 %s;\n%s", $Char::Elatin1::VERSION, $use_re_eval); # require run-time routines version
...
Char::Latin1 - Source code filter to escape Latin-1

=head1 SYNOPSIS

  use Char::Latin1;
  use Char::Latin1 version;         --- require version
