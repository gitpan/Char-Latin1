...
END
            ...
            if ($list !~ /\A \s* \z/oxms) {
                ...
                for (@list) {
                    $Char::Elatin1::function_ord     = 'Char::Latin1::ord'     if /\A ord \z/oxms;
                    $Char::Elatin1::function_ord_    = 'Char::Latin1::ord_'    if /\A ord \z/oxms;
                    $Char::Elatin1::function_reverse = 'Char::Latin1::reverse' if /\A reverse \z/oxms;
                    $Char::Elatin1::function_getc    = 'Char::Latin1::getc'    if /\A getc \z/oxms;
                }
            }
        }
    }

    $e_script .= Char::Latin1::escape();
...
=head1 Calling 'Char::Elatin1::ignorecase()' (Char::Latin1 software provides)

Char::Latin1 software applies calling 'Char::Elatin1::ignorecase()' instead of /i modifier.
...
=head1 Un-Escaping \ of \N, \p, \P, and \X (Char::Latin1 software provides)

Char::Latin1 software removes '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
=head1 Escaping Built-in Functions (Char::Latin1 software provide)
...
=head1 Un-Escaping bytes::* Subroutines (Char::Latin1 software provides)

Char::Latin1 software removes 'bytes::' at head of subroutine name.
...
some bugs. Thus, if you happen to find a bug that's in Char::Latin1 software and
