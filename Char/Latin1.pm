...
# split
            ...
            my $e_string = 'Char::Elatin1::split';
...
and the cellular phone. This software treats Latin-1 directly. Therefor there is
not UTF8 flag.
...
=item * Possible to handle raw Latin-1 values

=item * Backward compatibility of data, script and how to

=item * Only Char/Latin1.pm and Char/Elatin1.pm, other modules are unnecessary
...
functions.
  ...
  ---------------------------------
  lc          Char::Elatin1::lc
  lcfirst     Char::Elatin1::lcfirst
  uc          Char::Elatin1::uc
  ucfirst     Char::Elatin1::ucfirst
  chr         Char::Elatin1::chr
  glob        Char::Elatin1::glob
  ---------------------------------
...
Char/Latin1.pm remove 'bytes::' at head of function name.
...
=head1 Perl5.6 Emulation On perl5.005
  ...
  --------------------------------------------------------------------
  Before          After                  in BEGIN { } of Char/Elatin1.pm
  --------------------------------------------------------------------
  binmode(...);   Char::Elatin1::binmode(...);   *CORE::GLOBAL::binmode = ...
  open(...);      Char::Elatin1::open(...);      *CORE::GLOBAL::open    = ...
  --------------------------------------------------------------------
...
=item * binmode (Perl5.6 emulation on perl5.005)
  ...
  * two arguments
  ...
  If you are using perl5.005 other than MacPerl, Char::Latin1 software emulate perl5.6's
...
=item * open (Perl5.6 emulation on perl5.005)
  ...
  * three arguments
  ...
  If you are using perl5.005, Char::Latin1 software emulate perl5.6's open function.
  ...
  open(FH, "<:crlf:encoding(Char::Latin1)", $path) or die "can't open $path: $!";
