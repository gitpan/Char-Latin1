...
=item Chop string
  ...
  character chopped. The Char::Elatin1::chop function is used primary to remove the newline
...
=item Reverse index string
  ...
  This function works just like Char::Elatin1::index except that it returns the byte
...
=item Lower case string
  ...
  This function returns a lowercased version of Latin-1 $string (or $_, if
  $string is omitted). This is the internal function implementing the \L escape
  in double-quoted strings.

  You can use the Char::Elatin1::fc function for case-insensitive comparisons via Char::Latin1
  software.
...
=item Lower case first character of string
  ...
  This function returns a version of Latin-1 $string with the first character
...
=item Upper case string
  ...
  This function returns an uppercased version of Latin-1 $string (or $_, if
...
=item Fold case string
  ...
  New to Char::Latin1 software, this function returns the full Unicode-like casefold of
  Latin-1 $string (or $_, if omitted). This is the internal function implementing
...
=item Filename expansion (globbing)
  ...
  The Char::Elatin1::glob function grandfathers the use of whitespace to separate multiple
