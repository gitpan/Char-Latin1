...
=head1 Un-Escaping \ of \N, \p, \P, and \X (Latin1 software provides)

Latin1 software removes '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
=head1 Escaping Built-in Functions (Latin1 software provide)
