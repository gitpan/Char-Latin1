...
=item Chop string
  ...
  character chopped. The Elatin1::chop function is used primary to remove the newline
...
=item Reverse index string
  ...
  This function works just like Elatin1::index except that it returns the byte
...
=item Lower case string
  ...
  You can use the Elatin1::fc function for case-insensitive comparisons via Latin1
  software.
...
=item Fold case string
  ...
  New to Latin1 software, this function returns the full Unicode-like casefold of
...
=item Filename expansion (globbing)
  ...
  The Elatin1::glob function grandfathers the use of whitespace to separate multiple
