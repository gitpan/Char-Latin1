...
=item Make character
  ...
  set. For example, Elatin1::chr(65) is "A" in either ASCII or Latin-1, not Unicode,
  and Elatin1::chr(0x82a0) is a Latin-1 HIRAGANA LETTER A. For the reverse of
  Elatin1::chr, use Latin1::ord.
